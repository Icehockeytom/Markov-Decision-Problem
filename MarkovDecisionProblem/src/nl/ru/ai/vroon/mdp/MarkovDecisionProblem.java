...
public class MarkovDecisionProblem
{
  ...
  /**
   * Getter to get the transitionProbabilities
   */
  public double[] getTransitionProbabilities()
  {
    return new double[] { pPerform, pSidestep, pBackstep, pNoStep };
  }

  /**
   * Getter to get the posReward
   */
